<div class="form-group {{ $errors->has('house_no') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="house_no" type="text" id="house_no" value="{{ isset($address->house_no) ? $address->house_no : ''}}" >
...
<div class="form-group {{ $errors->has('sub_district') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="sub_district" type="text" id="sub_district" value="{{ isset($address->sub_district) ? $address->sub_district : ''}}" >
