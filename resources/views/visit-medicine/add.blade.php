            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{  route('visit-medicine.store',['page'=>$_GET['page']]) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="visit_id" value="{{$_GET['visit']}}">
                            @include ('visit-medicine.formAdd', ['formMode' => 'create'])
