...
class LabSubController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        LabSub::create($requestData);

        return redirect('backend/lab-sub')->with('flash_message', 'LabSub added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('backend/lab-sub')->with('flash_message', 'LabSub updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('backend/lab-sub')->with('flash_message', 'LabSub deleted!');
    }
}
