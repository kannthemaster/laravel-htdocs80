...
class LabItemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('lab-item.index', compact('labitem'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $labItem = LabItem::create($requestData);

        // return redirect('backend/lab-item')->with('flash_message', 'LabItem added!');
        return redirect(route('visit.edit',$labItem->visit()->id ))->with('LabItem', 'Lab added!');
    }
    ...
    public function show($id)
    {
        ...
        return view('lab-item.show', compact('labitem'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lab-item.edit', compact('labitem'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('visit.edit',$visit->id))->with('flash_message', 'LabItem updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('visit.edit',$visit->id))->with('flash_message', 'LabItem deleted!');
