...
final class RectorNodeTraverser extends NodeTraverser
{
     ...
     */
    public function __construct(private array $rectors, private array $collectorRectors, /**
     * @readonly
     */
    ...
    private function prepareNodeVisitors() : void
    {
        ...
        $nonCollectorActiveRectors = \array_filter($activeRectors, static fn(RectorInterface $rector): bool => !$rector instanceof CollectorRectorInterface);
