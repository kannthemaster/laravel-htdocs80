...
final class ValueResolver
{
     ...
     * @readonly
     */
    private CurrentFileProvider $currentFileProvider, ReflectionResolver $reflectionResolver, ClassReflectionAnalyzer $classReflectionAnalyzer)
    {
    ...
    private function resolveDirConstant() : string
    {
        ...
        return \dirname((string) $file->getFilePath());
    }
