...
final class ProcessCommand extends Command
{
     ...
     * @readonly
     */
    private ApplicationFileProcessor $applicationFileProcessor, DynamicSourceLocatorDecorator $dynamicSourceLocatorDecorator, /**
     * @readonly
     */
    private OutputFormatterCollector $outputFormatterCollector, SymfonyStyle $symfonyStyle, /**
     * @readonly
     */
